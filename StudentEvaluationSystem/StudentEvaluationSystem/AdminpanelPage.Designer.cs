namespace StudentEvaluationSystem
{
	partial class AdminpanelPage
	{
		...
		private void InitializeComponent()
		{
			...
			this.Add_New_Group_Schedule_Btn.TabIndex = 37;
			...
			this.Group_Schedule_End_Time.TabIndex = 35;
			// 
			// label1
			// 
			...
			this.Group_Schedule_Begin_Time.TabIndex = 33;
			// 
			// Group_Schedule_Name
			// 
			...
			this.Group_Schedule_Name.TabIndex = 32;
			...
			this.Add_New_Group_Type_Btn.TabIndex = 42;
			...
			this.Group_Type_Name.TabIndex = 41;
			...
			this.Group_Schedule_Id.TabIndex = 40;
			// 
			// Groups_Tab
			// 
			...
			this.Group_Mentor_Id.TabIndex = 32;
			// 
			// Group_Type_Id
			// 
			...
			this.Group_Type_Id.TabIndex = 30;
			// 
			// Group_Teacher_Id
			// 
			...
			this.Group_Teacher_Id.TabIndex = 31;
			// 
			// Students_Tab
			// 
